---
title: "Laporan w08 — Ringkasan Jawaban (diambil langsung dari answers.py)"
format:
  html:
    toc: true
    toc-depth: 2
...
✅ **Sumber kebenaran tunggal tetap:** `submissions/w08/answers.py`  
...
```bash
pytest -q tests_bank/w08/quiz_tests.py
```
