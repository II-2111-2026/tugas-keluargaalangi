---
title: "Laporan w04 — Ringkasan Jawaban (diambil langsung dari answers.py)"
format:
  html:
    toc: true
    toc-depth: 2
...
✅ **Sumber kebenaran tunggal tetap:** `submissions/w04/answers.py`  
...
```bash
pytest -q tests_bank/w04/quiz_tests.py
```
