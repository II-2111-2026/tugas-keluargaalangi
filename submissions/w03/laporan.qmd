---
title: "Laporan w03 — Ringkasan Jawaban (diambil langsung dari answers.py)"
format:
  html:
    toc: true
    toc-depth: 2
...
✅ **Sumber kebenaran tunggal tetap:** `submissions/w03/answers.py`  
...
```bash
pytest -q tests_bank/w03/quiz_tests.py
```
