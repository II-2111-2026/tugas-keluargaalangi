---
title: "Laporan w05 — Ringkasan Jawaban (diambil langsung dari answers.py)"
format:
  html:
    toc: true
    toc-depth: 2
...
✅ **Sumber kebenaran tunggal tetap:** `submissions/w05/answers.py`  
...
```bash
pytest -q tests_bank/w05/quiz_tests.py
```
