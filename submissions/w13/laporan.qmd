---
title: "Laporan w13 — Ringkasan Jawaban (diambil langsung dari answers.py)"
format:
  html:
    toc: true
    toc-depth: 2
...
✅ **Sumber kebenaran tunggal tetap:** `submissions/w13/answers.py`  
...
```bash
pytest -q tests_bank/w13/quiz_tests.py
```
