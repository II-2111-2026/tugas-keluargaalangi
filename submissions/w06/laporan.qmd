---
title: "Laporan w06 — Ringkasan Jawaban (diambil langsung dari answers.py)"
format:
  html:
    toc: true
    toc-depth: 2
...
✅ **Sumber kebenaran tunggal tetap:** `submissions/w06/answers.py`  
...
```bash
pytest -q tests_bank/w06/quiz_tests.py
```
