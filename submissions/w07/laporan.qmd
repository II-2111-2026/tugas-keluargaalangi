---
title: "Laporan w07 — Ringkasan Jawaban (diambil langsung dari answers.py)"
format:
  html:
    toc: true
    toc-depth: 2
...
✅ **Sumber kebenaran tunggal tetap:** `submissions/w07/answers.py`  
...
```bash
pytest -q tests_bank/w07/quiz_tests.py
```
