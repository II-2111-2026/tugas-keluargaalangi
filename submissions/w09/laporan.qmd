---
title: "Laporan w09 — Ringkasan Jawaban (diambil langsung dari answers.py)"
format:
  html:
    toc: true
    toc-depth: 2
...
✅ **Sumber kebenaran tunggal tetap:** `submissions/w09/answers.py`  
...
```bash
pytest -q tests_bank/w09/quiz_tests.py
```
