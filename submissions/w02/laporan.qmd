---
title: "Laporan w02 — Ringkasan Jawaban (diambil langsung dari answers.py)"
format:
  html:
    toc: true
    toc-depth: 2
...
✅ **Sumber kebenaran tunggal tetap:** `submissions/w02/answers.py`  
...
```bash
pytest -q tests_bank/w02/quiz_tests.py
```
