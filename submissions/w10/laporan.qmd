---
title: "Laporan w10 — Ringkasan Jawaban (diambil langsung dari answers.py)"
format:
  html:
    toc: true
    toc-depth: 2
...
✅ **Sumber kebenaran tunggal tetap:** `submissions/w10/answers.py`  
...
```bash
pytest -q tests_bank/w10/quiz_tests.py
```
